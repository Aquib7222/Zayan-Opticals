...
//     dispatch({ type: "ADD_TO_CART", payload: {id ,sunglasses,amount } });
//   };
...
//   const removeAllFromCarrt = ()=>{
//     dispatch({type: "REMOVE_ALL_FROM_CART"});
//   }
//   // use local storage for storing data in cart
//   useEffect(()=>{
...
//   return (
//     <CartContext.Provider value={{ ...state, addToCart,removeFromCart,removeAllFromCarrt }}>
//       {children}
