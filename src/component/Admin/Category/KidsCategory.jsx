...
export const KidsCategory = ({ products }) => {
  const [showKidsProduct, setShowKidsProduct] = useState(true);
      ...
      {showKidsProduct && (
        <div className="bg-white mx-4 rounded-3 px-3 mb-3 py-3">
          <div className="d-flex justify-content-between align-items-center">
            <h4 className="text-center bg-white py-3">Kids Products</h4>
            <button className="" onClick={() => setShowKidsProduct(false)}>
              X
            </button>
          </div>

          <div className="d-flex align-items-center">
            <h5 className="me-2">Kids Category :</h5>
            <select className="">
