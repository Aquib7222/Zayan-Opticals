...
export const UnisexCategory = ({ products }) => {
  const [showUnisexProduct, setShowUnisexProduct] = useState(true);
      ...
      {showUnisexProduct && (
        <div className="bg-white mx-4 rounded-3 px-3 mb-3 py-3">
          <div className="d-flex justify-content-between align-items-center">
            <h4 className="text-center bg-white py-3">Unisex Products</h4>
            <button className="" onClick={() => setShowUnisexProduct(false)}>
              X
            </button>
          </div>

          <div className="d-flex align-items-center">
            <h5 className="me-2">Unisex Category :</h5>
            <select className="">
